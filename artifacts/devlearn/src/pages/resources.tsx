...
import { useListResources, useListLanguages, useCreateResource, useDeleteResource, getListResourcesQueryKey } from "@workspace/api-client-react";
...
export default function Resources() {
  ...
  const onSubmit = (data: z.infer<typeof resourceSchema>) => {
    createResource.mutate(
      { data: { ...data, languageId: data.languageId || null, topicId: data.topicId || null } as any },
      {
        onSuccess: () => {
