...
import { Layers, Library, BrainCircuit, Code2, ArrowRight, Coffee, Cpu, Network, Terminal, Workflow } from "lucide-react";
...
export default function LanguageHub() {
  ...
  const Icon = languageIcons[slug!] || Code2;
  const colorClass = languageColors[slug!] || "text-primary";
