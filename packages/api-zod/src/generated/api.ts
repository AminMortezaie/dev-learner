 ...
 */
export const createArticleBodyQuizCountMax = 20;
...
export const CreateArticleBody = zod.object({
  ...
  "languageId": zod.number().nullish(),
  "tags": zod.string().optional(),
  "quizCount": zod.number().min(1).max(createArticleBodyQuizCountMax).optional().describe('Number of quiz questions to auto-generate (default 10)')
})
...
export const PolishArticleContentBody = zod.object({
  "content": zod.string().min(1)
})

export const PolishArticleContentResponse = zod.object({
  "content": zod.string()
})
