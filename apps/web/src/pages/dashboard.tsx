import { useGetDashboardStats, useGetLanguageProgress, useGetRecentActivity, useListLanguages } from "@devlearn/api-client";
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {langsLoading ? (
            ...
            languages?.map((lang) => {
              const Icon = getLanguageIcon(lang.slug);
              const colorClass = getLanguageColor(lang.slug);
